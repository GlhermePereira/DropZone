	...
	<div class="card">
		<div class="card-body">
			...
			<div id="drop-zone" class="drop-zone border">
				<span class="drop-text">{{__('Drag and drop files here or click to select file')}}</span>
			</div>
		</div>
	</div>

	<div class="progress mt-3">
		<div id="progress-bar" class="progress-bar" role="progressbar" style="width:0;" aria-valuenow="0" aria-valuemin="0" arial-valuemax="100">0%</div>
	</div>
            ...
            success: function(response) {
                ...
                if (response.success) {
                    response.filenames.forEach(function(filename) {
                        ...
                        imageThumbnail.src = `/images/${filename}`;
